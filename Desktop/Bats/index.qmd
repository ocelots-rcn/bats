...
Run this line of R code to see the dataset named “bats”.
...
Note: This analysis may take up to 2 minutes to complete. Please be patient and avoid clicking the Run Code button more than once.
...
Note: The output also includes two data frames, *\$coverage_based* and *\$AsyEst*, which we will not use in this analysis.
...
The output includes a data frame named \$*size_based* with estimates of species richness with 95% confidence intervals for sample sizes up to 187 individuals.
